defmodule ConnectixWeb.AgentLiveHelpersTest do
  ...
  setup do
    ...
    Mimic.copy(Connectix.Conversations)
  ...
  describe "handle_display_message_saved/2" do
    ...
    test "reloads from DB when conversation_id and scope exist" do
      scope = %Connectix.Accounts.Scope{user: %{id: 1}}
  ...
  describe "load_conversation/3" do
    ...
    test "returns {:error, socket} with flash when conversation not found" do
      ...
      |> stub(:get_conversation!, fn _scope, conversation_id ->
        raise KeyError, key: conversation_id, term: Connectix.Conversations.Conversation
      end)
