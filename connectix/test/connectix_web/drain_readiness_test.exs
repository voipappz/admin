defmodule ConnectixWeb.DrainReadinessTest do
  @moduledoc """
  ...
  test "readiness reports the drain window that liveness must not", %{conn: conn} do
    ...
    :ok = Supervisor.terminate_child(Connectix.Supervisor, Sagents.Supervisor)
    ...
    {:ok, _pid} = Supervisor.restart_child(Connectix.Supervisor, Sagents.Supervisor)
