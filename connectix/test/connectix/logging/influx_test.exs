defmodule Connectix.Logging.InfluxTest do
  ...
  defmodule StubHTTP do
    ...
    defp test_pid, do: Application.fetch_env!(:connectix, :influx_stub_pid)

    defp reply(verb),
      do: Application.get_env(:connectix, :influx_stub_replies, %{})[verb] || {:ok, 204}
  end
  ...
  setup do
    ...
    on_exit(fn ->
      ...
      Application.delete_env(:connectix, :influx_http)
      Application.delete_env(:connectix, :influx_stub_pid)
      Application.delete_env(:connectix, :influx_stub_replies)
  ...
  defp configure(pairs) do
    ...
    Application.put_env(:connectix, :influx_http, StubHTTP)
    Application.put_env(:connectix, :influx_stub_pid, self())
  end

  defp stub_reply(verb, reply) do
    replies = Application.get_env(:connectix, :influx_stub_replies, %{})
    Application.put_env(:connectix, :influx_stub_replies, Map.put(replies, verb, reply))
  end
