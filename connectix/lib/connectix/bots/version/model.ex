defmodule Connectix.Bots.Version.Model do
  ...
  def new(attrs \\ %{}) do
    ...
    errors =
      %{}
      |> Connectix.Bots.Version.inclusion(:provider, m.provider, @providers)
      |> Connectix.Bots.Version.range(:temperature, m.temperature, gte: 0, lte: 1)
      |> Connectix.Bots.Version.range(:thinking_budget_tokens, m.thinking_budget_tokens, gte: 1024)
      |> Connectix.Bots.Version.range(:max_output_tokens, m.max_output_tokens, gt: 0)
