 ...
 */
@Component({
    selector: 'janus-audioroom',
    templateUrl: './janus-audioroom.component.html',
    styleUrls: ['./janus-audioroom.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [JanusStore],
    standalone: false
})
export class JanusAudioroomComponent implements OnInit, OnDestroy, OnChanges {
    ...
    this.janusStore.state$.pipe(
      ...
      switch (roomInfo.state) {
        case RoomInfoState.initialized: {
          this.janusStore.attachAudioRoom(this.janusServerUrl);
          break;
        }
