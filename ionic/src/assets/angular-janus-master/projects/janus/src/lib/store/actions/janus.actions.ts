...
/** @internal */
export const ATTACH_AUDIO_ROOM = '[Janus] Attach AudioRoom';
/** @internal */
export const ATTACH_AUDIO_ROOM_FAIL = '[Janus] Attach AudioRoom Fail';
/** @internal */
...
/** @internal */
export class AttachAudioRoom implements Action {
  readonly type = ATTACH_AUDIO_ROOM;
  constructor(public payload: string) {}  // Janus URL
}

/** @internal */
export class AttachAudioRoomFail implements Action {
  readonly type = ATTACH_AUDIO_ROOM_FAIL;
  constructor(public payload: any) {}
}
