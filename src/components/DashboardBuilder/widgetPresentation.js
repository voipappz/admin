 ...
 * threshold colouring. Kept free of JSX so the dashboard, the builder and any
 * future unit tests all share one source of truth. Ported near-verbatim from
 * app's DashboardBuilder/widgetPresentation.js.
 */
...
/**
 * A widget's raw value -> the string on the tile. Duration-ish fields (billsec,
 ...
 * LOW is bad (an answer-rate percentage). Returns the widget's own colour
