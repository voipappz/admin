defmodule Connectix.Bots.Version.Limits do
  ...
  def new(attrs \\ %{}) do
    ...
    errors =
      %{}
      |> Connectix.Bots.Version.range(:max_runs, m.max_runs, gt: 0, lte: 50)
      |> Connectix.Bots.Version.range(:tool_timeout_ms, m.tool_timeout_ms, gt: 0)
      |> Connectix.Bots.Version.range(:session_idle_timeout_seconds, m.session_idle_timeout_seconds, gt: 0)
      |> Connectix.Bots.Version.range(:max_session_seconds, m.max_session_seconds, gt: 0)
      |> Connectix.Bots.Version.range(:token_budget, m.token_budget, gt: 0)
