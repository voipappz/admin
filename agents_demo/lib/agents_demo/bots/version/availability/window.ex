defmodule AgentsDemo.Bots.Version.Availability.Window do
  ...
  def new(attrs) do
    m = AgentsDemo.Bots.Version.take(attrs, %__MODULE__{}, [:day, :start_minute, :end_minute])
    day = to_day(m.day)
    ...
    errors =
      ...
      |> AgentsDemo.Bots.Version.range(:start_minute, m.start_minute, gte: 0, lte: 1439)
      |> AgentsDemo.Bots.Version.range(:end_minute, m.end_minute, gt: 0, lte: 1440)
      |> order(m.start_minute, m.end_minute)

    AgentsDemo.Bots.Version.done(errors, %__MODULE__{day: day, start_minute: m.start_minute, end_minute: m.end_minute})
  end
