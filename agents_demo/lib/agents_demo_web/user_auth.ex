defmodule AgentsDemoWeb.UserAuth do
  ...
  @remember_me_cookie "_agents_demo_web_user_remember_me"
  @remember_me_options [
    sign: true,
  ...
  def log_out_user(conn) do
    ...
    if live_socket_id = get_session(conn, :live_socket_id) do
      AgentsDemoWeb.Endpoint.broadcast(live_socket_id, "disconnect", %{})
    end
  ...
  the `current_scope`:
      ...
      defmodule AgentsDemoWeb.PageLive do
        use AgentsDemoWeb, :live_view

        on_mount {AgentsDemoWeb.UserAuth, :mount_current_scope}
        ...
      end

  Or use the `live_session` of your router to invoke the on_mount callback:

      live_session :authenticated, on_mount: [{AgentsDemoWeb.UserAuth, :require_authenticated}] do
