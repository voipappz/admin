defmodule AgentsDemo.Realtime.TokenAuthTest do
  ...
  setup do
    ...
    verifier = Application.get_env(:agents_demo, :token_verifier)
    Application.put_env(:agents_demo, :token_verifier, StubVerifier)

    on_exit(fn ->
      case verifier do
        nil -> Application.delete_env(:agents_demo, :token_verifier)
        module -> Application.put_env(:agents_demo, :token_verifier, module)
      end
    end)
